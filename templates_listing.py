...
#   Name: templates_listing.py
#   Purpose: List the templates available in VDC, for regions and zones
#   Requires: class VDCApiCall in the file vdc_api_call.py
# See the repo: https://github.com/Interoute/API-fun-and-education

# You can pass options via the command line: type 'python templates_listing.py -h'
...
# **************** TO BE WRITTEN - ALL FOLLOWING IS FOR REUSE *************************
